"""
Django settings for tet8723_2 project.
...
WSGI_APPLICATION = 'tet8723_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tet8723_2 API",
    "DESCRIPTION": "API documentation for tet8723_2 App",
    "VERSION": "v1",
}
